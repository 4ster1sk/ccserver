...
import { persistentHomeDir, sandboxAvailable } from './sandbox.js';
...
test('explicit sandbox request without bwrap is refused, not silently unsandboxed', { skip: sandboxAvailable() }, async () => {
